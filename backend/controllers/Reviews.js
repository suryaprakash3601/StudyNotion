...
exports.getAllReviewOfCourse = async (req, res) => {
  try {
    const { courseId } = req.query;  // GET requests use query params, not body
...
exports.getAvgRating = async (req, res) => {
  try {
    const courseId = req.query.courseId;  // GET requests use query params, not body
...
exports.getInstructorReviews = async (req, res) => {
  try {
    ...
    // Find all reviews for those courses
    const reviews = await RatingAndReviews.find({ course: { $in: courseIds } })
      .populate("user", "fName lName email profilePic")
