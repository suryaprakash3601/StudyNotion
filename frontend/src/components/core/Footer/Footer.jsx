    ...
    <footer className="w-full bg-richblack-800 text-pure-greys-200 px-6 py-10">
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex gap-6 text-xl mt-2">
          <a
            href="https://github.com/suryaprakash3601"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/surya-prakash-it/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-yellow-50 transition"
          >
          ...
          <a
            href="https://x.com/SuryaPr59171068"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-yellow-50 transition"
          >
          ...
          <a
            href="https://www.instagram.com/its_surya_0004?igsh=MWYyaWxxODd6Z24xdQ=="
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-yellow-50 transition"
          >
      ...
      <div className="text-center text-sm text-pure-greys-300">
        Made with ❤️ Surya Prakash © 2025 Studynotion
      </div>
    </footer>
  );
