...
export const courseEndpoints = {
  ...
  // Authenticated endpoint – returns full details including video URLs
  GET_FULL_COURSE_DETAILS_AUTHENTICATED: BASE_URL + "/course/getFullVideoDetails",
  ...
  CERTIFICATE_GENERATE_API: BASE_URL + "/course/certificate/generate",
  CERTIFICATE_VERIFY_API: BASE_URL + "/course/certificate/verify",
