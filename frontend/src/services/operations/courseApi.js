...
export const createSubSection = async (data, token) => {
  ...
  try {
    ...
    console.log("CREATE SUBSECTION ERROR RESPONSE", error);
...
export const getFullVideoDetailsOfCourse = async (courseId, token) => {
  const toastId = toast.loading("Loading...")
  //   dispatch(setLoading(true));
  let result = null
  try {
    ...
    console.log("COURSE_FULL_VIDEO_DETAILS_API API RESPONSE............", response)
    ...
    console.log("COURSE_FULL_VIDEO_DETAILS_API API ERROR............", error)
    result = error.response.data
    // toast.error(error.response.data.message);
  }
  finally{
...
export const fetchInstructorReviews = async (token) => {
  let result = []
  try {
    const response = await apiConnector(
      "GET",
    ...
    console.log("GET_INSTRUCTOR_REVIEWS_API RESPONSE............", response)
    if (!response?.data?.success) {
      throw new Error(response.data.message)
    }
    result = response?.data?.data
  } catch (error) {
    console.log("GET_INSTRUCTOR_REVIEWS_API ERROR............", error)
  }
  return result
}